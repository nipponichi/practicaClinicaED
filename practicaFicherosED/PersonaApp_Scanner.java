...
public class PersonaApp_Scanner {
	...
	public void registroPaciente(String dni, boolean esVisita, boolean esPacienteNuevo) {
		System.out.println("********************************\n"
		...
		if (dni!= null && esVisita == false) {
			...
			Paciente pacienteNuevo = new Paciente(nombre, edad, calle, localidad,
					codPostal,dni);
			//Añadimos paciente a arraylist de pacientes.
	 ...
	 */
	@SuppressWarnings("resource")
	public void registroVisita(String dni) {
		boolean esDniValido;
